		...
		<div class="col-md-8 col-md-offset-2" >
			<div class="col-md-12">
				...
				<p>
					...
					desenvolvido em Java, utilizando-se os recursos da tecnologia JavaEE, HTML e CSS, além do
					framework Bootstrap, todos apresentados em aula. Porém, seguindo conselhos de nosso
